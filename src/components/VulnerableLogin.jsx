...
import { vulnerableLogin, getUsers } from "../services/api";
...
export default function VulnerableLogin() {
  ...
  const [steps, setSteps] = useState([
    ...
    { key: "clientQuery", title: "Client builds vulnerable SQL", status: "pending" },
    { key: "send", title: "Send request to server", status: "pending" },
    { key: "serverReceive", title: "Server receives credentials", status: "pending" },
    { key: "serverProcess", title: "Server constructs SQL and checks injection", status: "pending" },
  ...
  return (
    <div className="grid-2">
      <div className="card">
        ...
        <div className="banner banner-warning">Vulnerable to SQL injection</div>
        ...
        <div className="buttons">
          <button className="btn btn-danger" onClick={handleLogin} disabled={loading}>{loading ? "Loading..." : "Login (Vulnerable)"}</button>
        ...
        {loginResult && (
          <div style={{ marginTop: 12 }}>
            <QueryDisplay
              ...
              parameters={null}
              isVulnerable
              injectionDetected={loginResult.injectionDetected}
            />
